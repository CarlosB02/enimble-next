                ...
                <div className="container header-container">
                    ...
                    <nav className="main-nav desktop-nav">
                        <ul>
                            ...
                            <li><Link href="/contactos" className="btn-nav">Marcar um café <img src="/assets/coffee CTA.webp" alt="café" className="coffee-emoji-img" /></Link></li>
                        </ul>
                    </nav>
                </div>
            </header>
                    ...
                    <ul className="mobile-menu-links">
                        ...
                        <li className="menu-item-animate action-btn-li">
                            <Link href="/contactos" className="btn-nav btn-nav-gradient" onClick={() => setIsMobileMenuOpen(false)}>
                                Marcar um café <img src="/assets/coffee CTA.webp" alt="café" className="coffee-emoji-img" />
                            </Link>
                        </li>
                    </ul>
